...
class Tweet(models.Model):
	...
	lang = models.CharField(blank=True, null=False)
	
	# from user object api
	user_id_str = models.CharField(max_length=100, unique=True, blank=False) # string of user id
	name = models.CharField(max_length=100, blank=False) # user real name
	screen_name = models.CharField(max_length=100, blank=False) # screen name

...
study_test_data = {'study_id': 123456789, 'study_id_str': '123456789'}
tweet_test_data = {
...
# initialize tweet collection and delete temp data from tweet collection
tweet_collection = twitter_db["tweet_collection"]
tweet_collection.insert_one(tweet_test_data)
twitter_db.tweet_collection.remove({"created_at":"Thu Jan 31 19:34:47 +0000 2019"})

# initialize tweet_study collection and delete temp data from tweet_study collection
study_index_collection = twitter_db["study_index_collection"]
study_index_collection.insert_one(study_test_data)
twitter_db.study_index_collection.remove({'study_id': 123456789, 'study_id_str': '123456789'})
